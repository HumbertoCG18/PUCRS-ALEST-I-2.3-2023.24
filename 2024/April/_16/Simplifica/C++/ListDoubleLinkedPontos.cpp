...
#include "ListDoubleLinkedPontos.h"

using namespace std;

// Construtor
ListDoubleLinkedPontos::ListDoubleLinkedPontos()
{
    clear();
}
...
* Esvazia a lista.
*/
void ListDoubleLinkedPontos::clear()
{
    Ponto p = {0,0};
    header = new Node(p);
    trailer = new Node(p);
...
*/
bool ListDoubleLinkedPontos::isEmpty()
{
    return count == 0;
}
...
*/
int ListDoubleLinkedPontos::size()
{
    return count;
}
...
*/
void ListDoubleLinkedPontos::add(Ponto element)
{
...
* 
*/
void ListDoubleLinkedPontos::add(int index, Ponto element)
{
...
*/
Ponto ListDoubleLinkedPontos::get(int index)
{
    if (index < 0 || index >= count)
    {
        throw "Índice inválido";
 ...
 * @throws exception se (index < 0 || index >= size())
 */
Ponto ListDoubleLinkedPontos::set(int index, Ponto element)
{
    if ((index < 0) || (index >= count))
    {
        throw "Índice inválido!";
 ...
 */
bool ListDoubleLinkedPontos::contains(Ponto element)
{
 ...
 */
bool ListDoubleLinkedPontos::remove(Ponto element)
{
}
 ...
 */
Ponto ListDoubleLinkedPontos::removeByIndex(int index)
{
    if ((index < 0) || (index >= count))
    {
        throw "Índice inválido!";
 ...
 */
int ListDoubleLinkedPontos::indexOf(Ponto element)
{
    Node *ptr = header->next;
    for (int pos = 0; pos < count; pos++)
    {
        if (ptr->item.x == element.x && ptr->item.y == element.y)
            return pos;
        ptr = ptr->next;
    }
...
*/
string ListDoubleLinkedPontos::toString()
{
    ostringstream aux;
    aux << "[ ";
    Node *ptr = header->next;
...
/*
void ListDoubleLinkedPontos::addFirst(int e)
{
    Node *n = new Node(e);
...
int ListDoubleLinkedPontos::getFirst()
{
    if (count == 0)
        throw "Lista vazia!";
...
int ListDoubleLinkedPontos::getLast()
{
    if (count == 0)
        throw "Lista vazia!";
...
int ListDoubleLinkedPontos::removeFirst()
{
    if (count == 0)
        throw "Lista vazia!";
...
int ListDoubleLinkedPontos::removeLast()
{
    if (count == 0)
        throw "Lista vazia!";
